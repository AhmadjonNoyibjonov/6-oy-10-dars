...
function Hero() {
  ...
  const texts = {
    ...
    uz: {
      ...
      description:
        "Eng yangi mahsulotlarni onlayn tarzda oling va mazali taomlar tayyorlang.",
    ...
    ru: {
      ...
      groceries: "продукты",
      description:
        "Получайте свежие продукты онлайн, не выходя из дома, чтобы приготовить вкусную еду из свежайших ингредиентов.",
